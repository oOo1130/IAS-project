    ...
    <v-dialog v-model="visibleDialog" persistent>
      ...
      <v-card>
        ...
        >
          ...
          <v-tab href="#tabs-tiling" class="primary--text">
            Tiling
          </v-tab>
          <v-tab href="#tabs-metadata" class="primary--text">
            Metadata
          </v-tab>
          <v-tab
            href="#tabs-name-type"
...
export default {
  ...
  computed: {
    ...
    exampleFileName() {
      const fileNameOnly = getFileName(this.selectedFileName);
      let html = '',
        start = 0,
        str = '';
