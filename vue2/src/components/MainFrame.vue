...
import DLMLTab from './leftToolBar/tabs/DLMLTab';
import AdjustTab from './leftToolBar/tabs/AdjustTab';
import FilterTab from './leftToolBar/tabs/FilterTab';
import FileTab from './leftToolBar/tabs/FileTab';
import ViewTab from './rightToolBar/tabs/ViewTab';
import MeasureTab from './rightToolBar/tabs/MeasureTab';
import ReportTab from './rightToolBar/tabs/ReportTab';
import SettingsTab from './rightToolBar/tabs/SettingsTab';
